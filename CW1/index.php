...
<div class="products">
  ...
  <h1 class="heading">Products</h1>
   <form class="search" action="index.php" method="post">
     <input type="text" name="searchbar" class="searchbar"  value="">
   ...
   <table>
      ...
      ?>
         <tr>
            ...
            <td>EGP<?php echo $fetch_cart['price']; ?>/-</td>
            <td>
            ...
            <td>EGP<?php echo $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?>/-</td>
      ...
      <tr class="table-bottom">
         ...
         <td>EGP<?php echo $grand_total; ?>/-</td>
